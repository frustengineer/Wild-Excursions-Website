...
export const safariBookingPages: Record<string, SafariBookingPageData> = {
  pench: {
    ...
    heroImage: penchHero,
    heroAlt: 'Black leopard walking through dense forest in the Pench landscape',
    zonesImage: tigerForest,
    zonesAlt: 'Bengal tiger walking through forest habitat in Pench Tiger Reserve',
  ...
  kanha: {
    ...
    heroImage: kanhaHero,
    heroAlt: 'Barasingha deer standing in a misty sal forest in Kanha National Park',
    zonesImage: tigerGrassland,
    zonesAlt: 'Bengal tiger walking through tall grass in Kanha National Park',
  ...
  bandhavgarh: {
    ...
    heroImage: bandhavgarhHero,
    heroAlt: 'Elephant herd crossing open grassland in the Bandhavgarh landscape',
    zonesImage: tigerForest,
    zonesAlt: 'Bengal tiger walking through forest habitat in Bandhavgarh Tiger Reserve',
