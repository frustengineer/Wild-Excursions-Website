...
// India is pinned first as the default; the rest follow alphabetically by name.
export const COUNTRY_CODES: CountryCode[] = [
  ...
  { iso: 'CG', name: 'Congo (Brazzaville)', dial: '+242', flag: '🇨🇬' },
  { iso: 'CD', name: 'Congo (Kinshasa)', dial: '+243', flag: '🇨🇩' },
