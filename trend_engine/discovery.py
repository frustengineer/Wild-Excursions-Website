...
Find up to 12 candidate topics that a real traveller, wildlife enthusiast, photographer, or safari buyer could plausibly be searching now. Favor:
...
Keep the result concise to reduce token usage.
...
def score_candidates_with_llm(
    ...
    # Bound candidate scoring so discovery stays cheap. Deep research happens later
    # only for the very best 1-2 opportunities.
    candidates = sorted(
        candidates,
